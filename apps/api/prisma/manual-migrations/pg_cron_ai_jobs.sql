...
--            утечка файла хуже потерянного анализа), ПЛЮС (аудит
--            2026-09-02) голосовые реплики без вебхука: PENDING старше
--            30 мин / PROCESSING старше 5 мин → FAILED с причиной
--            (stt/voice-reply-reaper.service.ts). Расписание не
--            меняется — тот же тик, тот же секрет.
