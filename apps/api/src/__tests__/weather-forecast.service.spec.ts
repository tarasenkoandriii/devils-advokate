...
async function run() {
  ...
  test('generateByCity() бросает BadRequestException для пустого названия города', async () => {
    ...
    const svc = new WeatherForecastService(prisma as any, new FakeAIRouterService() as any, new FakeConsentService() as any);
  ...
  test('generateByGeolocation() требует ConsentType.LOCATION', async () => {
    ...
    const svc = new WeatherForecastService(prisma as any, new FakeAIRouterService() as any, fakeConsent as any);
  ...
  test('generateByCity() подмешивает выбранный ближайший час прогноза в промпт', async () => {
    ...
    const svc = new WeatherForecastService(prisma as any, fakeRouter as any, new FakeConsentService() as any);
  ...
  test('previewForScheduling() честно возвращает null, если AI-провайдер недоступен', async () => {
    ...
    const svc = new WeatherForecastService(prisma as any, failingRouter as any, new FakeConsentService() as any);
